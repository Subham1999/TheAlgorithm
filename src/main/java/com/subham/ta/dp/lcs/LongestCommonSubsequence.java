 ...
 * sequence2 : {b x q a d a e f y a g}
 */
public class LongestCommonSubsequence {
    ...
    static class SimpleSolution {
        public static int longestCommonSubsequenceLength(String a, String b) {
            return (a == null || b == null) ? 0 : longestCommonSubsequenceLength(a, b, a.length() - 1, b.length() - 1);
        }
        ...
        private static int longestCommonSubsequenceLength(String a, String b, int i, int j) {
            ...
            if (a.charAt(i) == b.charAt(j)) {
                ...
                return Math.max(longestCommonSubsequenceLength(a, b, i, j - 1),
    ...
    static class SolutionWithMemoization {
        public static int longestCommonSubsequenceLength(String a, String b) {
            ...
            return (a == null || b == null) ? 0 : longestCommonSubsequenceLength(a, b, a.length() - 1, b.length() - 1, memo);
        }

        private static int longestCommonSubsequenceLength(String a, String b, int i, int j, Map<Pair<Integer, Integer>, Integer> memo) {
            if (i < 0 || j < 0) {
                return 0;
            }
            ...
            if (a.charAt(i) == b.charAt(j)) {
                ...
                answer = Math.max(longestCommonSubsequenceLength(a, b, i, j - 1, memo),
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SolutionWithMemoization.longestCommonSubsequenceLength("abcdefg", "bxqadaefyag"));
    }
}
